...
WSSL's Development Academy is offered for players in U6 to U14. The structure of the Development Academy Program is as follows:

- Players receive one training session each week with NY Red Bulls trainers for a minimum of seven sessions (10 sessions in Winter).
- Each session is 60 minutes long and conducted in an indoor UWS facility.
- Each session is limited to 12-15 players with multiple sessions per age group based on demand.
- Players commit to the DA program in addition to weekly Core teams, training and games.
