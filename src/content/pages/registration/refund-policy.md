...
title: Refund Policy
path: refund-policy
legacyUrl: /registration/refund-policy/
updated: 2020-12-27
---
...
Refunds of core player fees (less an administrative fee of $30) only will be given (1) to those players who are waitlisted and whom we are not able to place on a team by the 3rd week of the season, (2) to those players that are injured and notify the Registrar directly (registrar@wssl.org) of the injury before the season begins, accompanied by a doctor's note, and (3) who notify the Registrar directly (registrar@wssl.org) of their desire to withdraw BEFORE the refund deadline. The refund deadline is posted on the home page and is March 1 for the Spring Season and July 15 for the Fall Season.
...
Please e-mail any refund request to the Registrar ([registrar@wssl.org](mailto:registrar@wssl.org)). Your request must include your name, the player's name, and the player's date of birth.
