...
![](/assets/legacy/File/How_To_Become_An_Adult_Referee_v4.JPG)

Follow these steps and join the crew!

- Login to [WSSL](https://inleague.wssl.org) and go to “Family Profile“ and click the green button Add New User, if your name is not already listed.
...
- Be on the lookout for an email from "Verified Volunteers" or "Sterling Volunteers” within the next couple of days. Follow the instructions in this message. It often goes to junk/spam, so check there, too. Your background check and AYSO registration will **not** be initiated until you complete the steps listed in the email message. If you have any issues, please contact cvpa@wssl.org.

Register for all in-person and online courses by logging in to our training website: from any inLeague page, look for the **eTrainU Graduation Cap Icon ![](/assets/legacy/File/Mortar_Board.JPG)** on the top-right. Click on that icon, and then click on ![](/assets/legacy/File/Log_Into_AYSOU.JPG)on the next page. There are no separate credentials; you log in to inLeague first and then go to eTrainU from there.
...
- **SafeSport** - Please visit [SafeSport](/volunteers/volunteers/safesport/) for more information. To access the training paid for by WSSL, you must access the SafeSport website from the [link](https://inleague.wssl.org/app/eTrainU) [![](/assets/legacy/File/SafeSport_Link.JPG)](https://inleague.wssl.org/app/eTrainU). Unlike Safe Haven and Concussion, this is an annual requirement.
...
Once you attend the class and pass the exam, you are now a certified soccer referee! We will give you a uniform and kit for free: send an email to **Uniforms.WSSL@gmail.com** including your name and shirt size (Youth, Adult Small, Medium, Large, XL or 2XL). The pick-up location is the Field House at the northeast corner of the 101st Street & Riverside Park soccer field (in the park next to the Henry Hudson Parkway).

Please email your [Division Chief Referee](/programs/core/divisions/) or the Regional Referee Administrator, [Stan Ince](mailto:stan.ince@gmail.com), with any questions.
