...
[Can I skip safe haven or concussion awareness?](<#safe haven>)
...
A: WSSL uses an [online scheduling system](/volunteers/referees/referee-scheduler/) that allows you to choose the games that work for your schedule.
...
A: A list of division heads can be found [here](/programs/core/divisions/).

Q: When will I know what team my child is on?

A: Information about team formation can be found [here](/programs/core/team-formation/). [Contact](/programs/core/divisions/) your division head. Usually teams are posted a couple of weeks before the season starts.

Q: What day do we play on and where do we play?

A: Check the division information [here](/programs/core/divisions/). This is the list of what we HOPE will happen, but sometimes we have to change fields and days depending on registration numbers and permit availability.
