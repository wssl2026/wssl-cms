---
title: Become a Teen Referee
path: referees/teen-referee
legacyUrl: /volunteers/referees/teen-referee/
updated: 2024-02-26
---
...
For more information or for help getting involved, please contact [John Drayton](mailto:drayts@aol.com), our Youth Referee Program Director.
...
![](/assets/legacy/File/How_To_Become_A_Teen_Referee_v4.JPG)

Part 1: Parents register their child as a Youth Referee Volunteer

1. **Parents:**  Youth volunteers must be added to their Family Profile created when their parents joined WSSL. Please do not create a "standalone" profile. This is because AYSO requires that we send the related adult information with the youth volunteer record. Note that Player registration does not translate to Volunteer registration; they are two different things.

2. Make sure that your teen volunteer has a unique email address that is used only by them and not shared with parents or other family members.
    To add your teen ref, log in to your [WSSL in-league account](http://inleague.wssl.org/) and click on Family Profile. Click the green **Add New User** button and follow the prompts to provide the information about the teen referee.

3. Under volunteer options, select "Referee". The system will automatically recognize your teen as a teen referee based on their birthdate.

4. Click the green **Register Volunteers** button and follow the prompts. Once on the Volunteer Preferences page, check the box for Referee, and add the divisions that your teen wants to work in. This is used for communication purposes, and in fact referees can officiate games in any division for which they are certified.

5. **Log out**. Do not go straight to the online training, otherwise the training will be credited to your email address and account, and not to your teen referee.
...
The training requirements are set out in the flow diagram above and explained further on the page "[How to Become an Adult Referee](/volunteers/referees/new-referee/)". Before starting it is good to decide whether you want to referee games in 6U, 7U and 8U only (simpler rules and less training) or the more senior divisions 9U and up (they have goalkeepers and assistant referees and require more training).
...
2. Select "Referee Scheduler" from the options.
3. Select a Division and click "View Schedule".
4. Click "SIGN UP".
5. Congratulations! You have done it! You are a highly valued member of the WSSL referee team!
6. Please contact the Chief Referee for that division (names and emails are listed [here](/programs/core/divisions/)) if your plans change and you cannot ref a game you signed up for.
7. For confirmation letters or other high school service credit questions, please contact [John Drayton](<mailto:drayts@aol.com, jd34736@citi.com?subject=Teen%20Referee%20%2F%20Service%20Credits>), our Youth Referee Program Director.

**Parents!** Please help high school students earn service credits for being a WSSL teen referee. Please enter the contact information for your school’s service credit coordinator on [this Google doc](https://docs.google.com/forms/d/e/1FAIpQLScuTCj_C52hk0OGtyyha9VJoa0f-BQbo2ihuyqRQRQgQpPUkw/viewform?usp=sf_link). Each season we will send them an email explaining the benefits of being a volunteer teen referee and alert them to upcoming classes.

If new teen referees would like some help to get started, they will be paired up with an experienced referee for an initial game or two in the U6-U8 divisions. The mentor referee will go through the process of talking to coaches and players in the game and on the sideline, monitor the game and answer any questions at the breaks. To arrange a mentor, please contact [John Drayton](<mailto:drayts@aol.com, jd34736@citi.com?subject=Teen%20Referee%20%2F%20Service%20Credits>), our Youth Referee Program Director.
