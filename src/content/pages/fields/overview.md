...
title: Overview
path: overview
legacyUrl: /fields/overview/
updated: 2024-03-31
---

We have the privilege of playing on natural grass and artificial turf fields in Riverside Park, Central Park, Randall's Island, and a few others throughout the city. We work closely with the NYC Department of Parks and Recreation, the Central Park Conservancy, the Riverside Park Conservancy and the Randall's Island Park Alliance to care for and improve them.

Information on these pages gives you locations for each field, any special considerations, as well as instructions for the set up, break down and maintenance of the fields. If you want to find out what field your child plays on and on what day, see [DIVISIONS](/programs/core/divisions/).

### General Rules

- No smoking on or near any fields.
- No dogs allowed on or near any fields.
- No bicycles allowed on any fields. Please chain them to the OUTSIDE of the fence.
- Turf shoes are allowed on all fields.
- No cleats are allowed for ages U6-U8. Players should wear sneakers or turf shoes.
- Soccer cleats (NOT baseball or football cleats) may only be worn on turf fields (except at Riverbank State Park) and for travel/tournament teams (even if on grass fields).

Turf fields are Thomas Jefferson (114 & 1st), Frederick Douglass (101 & Amsterdam) and the 101st, 103rd and 107th street fields in Riverside Park. Grass fields are Central Park, the 74th Street track field and 71st Street field in Riverside Park, Van Cortlandt Park and most of our fields on Randall's Island.
...
Every WSSL player has a chance to play on nearly every field that we use. Field assignments are always dependent on the permits given to us by the Parks Department. Field assignments are configured -- by an expert committee of WSSL leadership and after careful analysis -- to best fit the soccer needs of the players from each age group. To find out where your child plays and on what days, see [DIVISIONS](/programs/core/divisions/).
...
Please check the website [homepage](/) for field updates/game status on days where rain, snow or other weather may interfere with WSSL's game schedule. WSSL communicates with the Parks Department early on days with weather questions and does its best to have any field closures or game cancellations posted by 7:30 am on the day of the games.
